    ...
    return (
        <motion.div
            ...
            className={cn(
                ...
                visible && " dark:bg-neutral-950/80 border",
                className,
            )}
        >
            {children}
    ...
    return (
        <motion.div
            ...
            className={cn(
                ...
                visible && "bg-gray-300 dark:bg-neutral-950/80",
                className,
            )}
        >
            {children}
        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    exit={{ opacity: 0 }}
                    className={cn(
                        "absolute inset-x-0 top-16 z-50 mt-1 border border-zinc-700 flex w-full flex-col items-start justify-start gap-4 rounded-lg bg-neutral-950 text-white px-4 py-8 shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] ",
                        className,
                    )}
                >
                    {children}
