...
//     // Check if content.processDescription exists and is long enough
...
//                                             <motion.div
//                                                 key={index}
//                                                 className="bg-white rounded-lg p-8 shadow-md hover:shadow-xl transition-shadow duration-300 border-t-4 border-[#bb8d03fc] h-full flex flex-col justify-between"
...
//                                                     </ul>
//                                                 </div>
//                                                 <Button className="bg-[#FFC107] hover:bg-[#FFA000] text-[#333333] px-8 py-3 rounded-lg font-bold text-lg shadow-md transition-all duration-300 hover:scale-105 mt-auto">
//                                                     Select Plan
//                                                 </Button>
//                                             </motion.div>
//                                         ))}
...
//                                     <form className="max-w-xl mx-auto bg-white p-8 rounded-lg shadow-md space-y-6 text-left">
//                                         <div>
...
//                                             <input type="email" className="mt-1 block w-full border border-gray-300 rounded-lg p-2" />
//                                         </div>
//                                         <div>
//                                             <label className="block text-sm font-medium text-[#333333]">Contact Number</label>
//                                             <input type="email" className="mt-1 block w-full border border-gray-300 rounded-lg p-2" />
//                                         </div>
//                                         <div>
//                                             <label className="block text-sm font-medium text-[#333333]">Project Note(Please briefly describe your {content.pageTitle} requirements. We'll connect with you soon for details.)</label>
//                                             <textarea className="mt-1 block w-full border border-gray-300 rounded-lg p-2" rows={4}></textarea>
//                                         </div>
...
//                                                 className="bg-[#bb8d03fc] text-white py-2 px-2 rounded-md hover:underline font-medium focus:outline-none mt-2"
//                                             >
...
//                             <ul className='flex justify-center text-[#666666] mb-8 text-sm space-x-4'>
                            ...
                            {content.pricingPlans && content.pricingPlans.length > 0 ? (
                                        ...
                                        {content.pricingPlans.map((plan, index) => (
                                            ...
                                            >
                                                ...
                                                <Button
                                                    ...
                                                    className="bg-[#FFC107] hover:bg-[#FFA000] text-[#333333] px-8 py-3 rounded-lg font-bold text-lg shadow-md transition-all duration-300 hover:scale-105 mt-auto">
                                                    Select Plan
                                                </Button>
                                            </motion.div>
                                        ))}
                                ...
                                <>
                                    ...
                                    <form onSubmit={onSubmit} className="max-w-xl mx-auto border  p-8 rounded-lg shadow-md space-y-6 text-left" encType="multipart/form-data">
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-[#333333]">Contact Number</label>
                                            <input type="phone" className="mt-1 block w-full border border-gray-300 rounded-lg p-2" />
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-[#333333]">Project Note(Please briefly describe your {content.pageTitle} requirements. We'll connect with you soon for details.)</label>
                                            <textarea className="mt-1 block w-full border border-gray-300 rounded-lg p-2" rows={4}></textarea>
