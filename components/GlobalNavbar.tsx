        ...
        <div className="relative w-full max-w-7xl flex items-center justify-between gap-4 pointer-events-auto">
          ...
          >
            <nav className="flex gap-8 text-white/80 text-sm  tracking-wider items-center">
              ...
              <button onClick={() => router.push("/contact")} className="hover:text-[#bb8d03fc] transition-colors">Contact</button>
        ...
        {isMenuOpen && (
          ...
          >
            ...
            <nav className="flex flex-col gap-6 text-center w-full max-w-md px-6 overflow-y-auto max-h-[80vh]">
              ...
              <button onClick={() => { router.push("/contact"); setIsMenuOpen(false); }} className="text-white text-3xl font-black uppercase tracking-tighter hover:text-[#bb8d03fc]">Contact</button>
            </nav>
          </motion.div>
        )}
      </AnimatePresence>
